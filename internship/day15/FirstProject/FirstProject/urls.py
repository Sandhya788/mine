...
urlpatterns = [
    ...
    path('usr/<str:uname>/',views.usrnameprint),
    path('usag/<str:un>/<str:ag>',views.usernameage),
    path('emp/<str:eid>/<int:eage>/<str:enm>/',views.empdetails),
    path('qw/',views.html),
    ...
    path('de/<int:d>/',views.delete,name='sd'),
]
