# Generated by Django 3.0 on 2021-07-08 10:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uimg', models.ImageField(default='logo.jpg', upload_to='Profilepics/')),
                ('role', models.CharField(choices=[(1, 'Guest'), (2, 'Manager'), (3, 'User')], default=1, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icategory', models.CharField(choices=[('NV', 'Non-Veg'), ('VG', 'Veg'), ('Df', 'Select Item')], default='Df', max_length=12)),
                ('iprice', models.DecimalField(decimal_places=2, max_digits=10)),
                ('imimg', models.ImageField(default='logo.jpg', upload_to='Itemimages/')),
